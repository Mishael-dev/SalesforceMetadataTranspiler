...
export const RollupSummaryFieldSchema = z
    ...
    if (!data.summarizedField.includes(".")) {
        ctx.addIssue({
            ...
            message: "summarizedField must include the object and field name, e.g., 'Child__c.Field__c'",
        });
    }
    if (!data.summaryForeignKey.includes(".")) {
        ctx.addIssue({
            ...
            message: "summaryForeignKey must include the object and field name, e.g., 'Child__c.Lookup__c'",
        });
    }
});
