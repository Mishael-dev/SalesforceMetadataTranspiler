...
export const CustomObjectSchema = z.object({
  ...
  deploymentStatus: z.enum(['InDevelopment', 'Deployed']).default('Deployed')
    .describe("'InDevelopment' hides the object from end-users; 'Deployed' makes it available for use."),

  allowInChatterGroups: z.boolean().default(true)
  ...
  enableLicensing: z.boolean().default(false)
  ...
  enableStreamingApi: z.boolean().default(true)
...
export type CustomObjectType = z.infer<typeof CustomObjectSchema>;